(function e(t, n, r) {
    ...
    4: [ function(require, module, exports) {
        (function(global, factory) {
            typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("preact")) : typeof define === "function" && define.amd ? define([ "preact" ], factory) : global.preactRouter = factory(global.preact);
            ...
            function exec(url, route) {
                ...
                var reg = /(?:\?([^#]*))?(#.*)?$/, c = url.match(reg), matches = {}, ret = void 0;
                if (c && c[1]) {
                    var p = c[1].split("&");
                ...
                for (var _i = 0; _i < max; _i++) {
                    if (route[_i] && route[_i].charAt(0) === ":") {
                        var param = route[_i].replace(/(^\:|[+*?]+$)/g, ""), flags = (route[_i].match(/[+*?]+$/) || EMPTY$1)[0] || "", plus = ~flags.indexOf("+"), star = ~flags.indexOf("*"), val = url[_i] || "";
            ...
            var Link = function(_ref) {
                ...
                return preact.h("a", babelHelpers.extends({}, props, {
            ...
            var Router = function(_Component) {
                ...
                function Router() {
                    ...
                    return _ret = (_temp = (_this = babelHelpers.possibleConstructorReturn(this, _Component.call.apply(_Component, [ this ].concat(args))), 
                    _this), _this.state = {
                ...
                Router.prototype.render = function render(_ref2, _ref3) {
                    ...
                    var active = children.slice().sort(pathRankSort).filter(function(_ref4) {
                        ...
                        var path = attributes.path, matches = exec(url, path, attributes);
                        if (matches) {
                            attributes.url = url;
            ...
            var Route = function(_ref5) {
                ...
                return preact.h(RoutedComponent, {
                    url: url,
                    matches: matches
                });
            };
    ...
    7: [ function(require, module, exports) {
        ...
        var App = function App() {
            return (0, _preact.h)(_preactRouter2.default, null, (0, _preact.h)(_views.Home, {
                path: "/"
            }));
        };
    ...
    9: [ function(require, module, exports) {
        ...
        var Store = function(_Event) {
            _inherits(Store, _Event);
            function Store() {
            ...
            _createClass(Store, [ {
                key: "grabData",
                value: function grabData(type, params) {
                    var self = this;
                    (0, _reqwest2.default)({
                        url: "/",
                        data: params,
                ...
                key: "setData",
                value: function setData(id, changes) {
                    var data = this.data;
                    ...
                    if (changes !== null) {
                        ...
                        if (current) {
                            ...
                            this.data = _immutable2.default.Map();
                        }
                    }
    ...
    10: [ function(require, module, exports) {
        ...
        exports.LiveScoring = exports.Roster = exports.Home = undefined;
        var _createClass = function() {
            function defineProperties(target, props) {
                for (var i = 0; i < props.length; i++) {
                    var descriptor = props[i];
        ...
        var Roster = exports.Roster = function(_Component2) {
            _inherits(Roster, _Component2);
            function Roster(props) {
                _classCallCheck(this, Roster);
                var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Roster).call(this, props));
                _this2.state = {};
                return _this2;
            }
            _createClass(Roster, [ {
        ...
        var LiveScoring = exports.LiveScoring = function(_Component3) {
            _inherits(LiveScoring, _Component3);
            function LiveScoring(props) {
                _classCallCheck(this, LiveScoring);
                var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(LiveScoring).call(this, props));
                _this3.state = {};
                return _this3;
            }
            _createClass(LiveScoring, [ {
                key: "shouldComponentUpdate",
                value: function shouldComponentUpdate(nextProps, nextState) {
                    return nextProps !== this.props;
                }
