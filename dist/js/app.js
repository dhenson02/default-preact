...
var button_ = document.getElementById('clicker');

var handleClick = function handleClick(event) {
    var noob_ = document.createElement('textarea');

    noob_.style = _immutable2.default.Map({
        borderColor: '#AACCEE',
        borderWidth: '3px',
        borderStyle: 'solid'
    }).toObject();
    ...
    _fastdom2.default.measure(function () {
        ...
        (0, _reqwest2.default)({
            ...
            success: function success(response) {
                var text = document.createTextNode(JSON.stringify(arguments));
